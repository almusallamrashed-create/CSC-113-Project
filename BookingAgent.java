...
public class BookingAgent {
    ...
    private static void startBot(BusCompany company, Scanner input) {
        ...
        while (isRunning) {
            ...
            switch (choice) {
                case "1": createBus(company, input); break;
                case "2": reserveTicket(company, input); break;
                case "3": cancelBus(company, input); break;
                case "4": System.out.println("[Bot]: Generating system report...\n" + company.toString()); break;
                case "5": System.out.println("[Bot]: Thank you for using our automated service. Goodbye!"); isRunning = false; break;
                default: System.out.println("[Bot]: I'm sorry, I didn't understand that. Please reply with a valid number.");
            }
        }
    }
